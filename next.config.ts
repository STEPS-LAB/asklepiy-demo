...
const nextConfig: NextConfig = {
  // Enable React strict mode for better performance testing
  ...
  images: {
    ...
    // Enable lazy loading with better placeholder
    loading: 'lazy',
  ...
  // Skip TypeScript checking during build (run type checking in CI)
  typescript: {
